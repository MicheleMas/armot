...
public class ConnectionsWindow extends JFrame {
	...
	public void updateTables(String[][] listIN, String[] columnNameIN, String[][] listOUT, String[] columnNameOUT) {
		panel.updateTables(listIN, columnNameIN, listOUT, columnNameOUT);
		pack();
	}
	
	/*
	public void uptateTables(String[][] listIN, String[] columnNameIN, String[][] listOUT, String[] columnNameOUT) {
		removeAll();
		...
		if (listIN != null) {
			...
			inviatiTable.setPreferredScrollableViewportSize(new Dimension(450, 500 / 2 - 27));
		...
		if (listOUT != null) {
			...
			ricevutiTable.setPreferredScrollableViewportSize(new Dimension(450, 500 / 2 - 27));
